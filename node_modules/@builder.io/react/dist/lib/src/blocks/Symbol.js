    ...
    SymbolComponent.prototype.render = function () {
        ...
        return ((0, core_1.jsx)(builder_store_1.BuilderStoreContext.Consumer, { key: (model || 'no model') + ':' + (entry || 'no entry') }, function (state) {
            ...
            return ((0, core_1.jsx)(TagName, __assign({ "data-model": model }, attributes, { className: (attributes.class || attributes.className || '') +
                    ...
                    ((symbol === null || symbol === void 0 ? void 0 : symbol.dynamic) || _this.props.dynamic ? ' builder-dynamic-symbol' : '') }), showPlaceholder ? (_this.placeholder) : ((0, core_1.jsx)(builder_component_component_1.BuilderComponent, __assign({}, (((_a = state.state) === null || _a === void 0 ? void 0 : _a.locale) && { locale: state.state.locale }), { isChild: true, ref: function (ref) { return (_this.ref = ref); }, context: __assign(__assign({}, state.context), { symbolId: (_b = _this.props.builderBlock) === null || _b === void 0 ? void 0 : _b.id }), modelName: model, entry: entry, data: __assign(__assign(__assign({}, data), (!!_this.props.inheritState && state.state)), (_h = (_g = (_f = (_e = (_d = (_c = _this.props.builderBlock) === null || _c === void 0 ? void 0 : _c.component) === null || _d === void 0 ? void 0 : _d.options) === null || _e === void 0 ? void 0 : _e.symbol) === null || _f === void 0 ? void 0 : _f.content) === null || _g === void 0 ? void 0 : _g.data) === null || _h === void 0 ? void 0 : _h.state), renderLink: state.renderLink, inlineContent: symbol === null || symbol === void 0 ? void 0 : symbol.inline }, (content && { content: content }), { options: { key: key, noEditorUpdates: true }, codegen: !!((_j = content === null || content === void 0 ? void 0 : content.data) === null || _j === void 0 ? void 0 : _j.blocksJs), hydrate: (_k = state.state) === null || _k === void 0 ? void 0 : _k._hydrate, builderBlock: _this.props.builderBlock, dataOnly: _this.props.dataOnly }), _this.props.children))));
        }));
    };
